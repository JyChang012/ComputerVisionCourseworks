...
def train():
    ...
    data_classify, data_regress, n = prepare_data_v2.get_data()
    ...
    train_data_classify, val_data_classify = prepare_data_v2.split_data(data_classify, n)
...
#
    ...
    train_data_regress, val_data_regress = prepare_data_v2.split_data(data_regress, n)
...
def train2():
    ...
    class2cor = prepare_data_v2.classes2cor
